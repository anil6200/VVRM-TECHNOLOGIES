      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold  font-mono tracking-wider leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-vvrm-cyan to-vvrm-blue font-space text-[38px] tracking-wide">Conversation</span> ?
          </h2>
        ...
        >
          ...
          >
            ...
            <span className='font-serif tracking-wide text-sm lg:text-lg '>vvrmtechnologies@gmail.com</span>
          </a>
        </motion.div>
      </div>
    </section>
