  ...
  return (
    <section className="relative w-full py-32 px-6 flex items-center justify-center overflow-hidden bg-vvrm-dark">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full    text-sm font-mono tracking-widest uppercase mb-6 backdrop-blur-md">
            Expert Guidance & Support
          </span>
          <h2 className="text-4xl md:text-6xl font-extrabold  font-mono tracking-wider leading-tight">
            Ready to Start the <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-vvrm-cyan to-vvrm-blue font-space text-[38px] tracking-wide">
              Conversation
            </span>{" "}
            ?
          </h2>
          <p className="text-gray-200 font-space text-lg md:text-xl max-w-2xl mx-auto mt-6 leading-relaxed">
            Whether you have a groundbreaking idea, a technical query, or just
            want to say hello — our team is ready to listen and answer.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            <span className="font-mono">Contact with us</span>
          ...
          >
            ...
            <span className="font-serif tracking-wide text-sm lg:text-lg ">
